...
RAW_PATH = Path("data/raw/ptf_mcp")
...
def validate_required_columns(df: pd.DataFrame) -> None:
    ...
    if missing_cols:
        raise ValueError(f"Eksik zorunlu kolonlar var: {missing_cols}")
...
def main():
    input_path =RAW_PATH 
    output_path = PROCESSED_PATH /"ptf_processed.parquet"
